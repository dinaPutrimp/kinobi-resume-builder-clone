...
function ResumeView() {
    const {
        personalInfo, worksExperience, educationBackground, organizationsExperience, othersAchievement, editor,
                    ...
                    <div className={`${editor.fontSize} text-blue-500 underline-offsite-2`} style={{ lineHeight: `${editor.lineHeight}px` }}>
                        ...
                        <span>
                            {personalInfo.linkedin !== '' ? (
                                <a target="_blank" href={personalInfo.linkedin} rel="noreferrer">
                                    {' '}
                                    |
                                    {personalInfo.linkedin}
                                </a>
                        ...
                        <span>
                            {personalInfo.portofolio !== '' ? (
                                <a target="_blank" href={personalInfo.portofolio} rel="noreferrer">
                                    {' '}
                                    |
                                    {personalInfo.portofolio}
                                </a>
                        ...
                        <div key={index}>
                            <div className="flex justify-between items-center mb-1">
                                <div style={{ lineHeight: `${editor.lineHeight}px` }}>
                                    <span className={`${editor.fontSize} font-semibold`}>{experience.company}</span>
                                    {' '}
                                    -
                                    <span className={`${editor.fontSize} font-semibold text-gray-500`}>{experience.companyLocation}</span>
                                </div>
                                <div className={editor.fontSize} style={{ lineHeight: `${editor.lineHeight}px` }}>
                ...
                <div className="mb-2">
                    ...
                    {educationBackground.map((education, index) => (
                        <div key={index}>
                            <div className="flex justify-between items-center mb-1">
                                <div style={{ lineHeight: `${editor.lineHeight}px` }}>
                                    <span className={`${editor.fontSize} font-semibold`}>{education.school}</span>
                                    {' '}
                                    -
                                    <span className={`${editor.fontSize} font-semibold text-gray-500`}>{education.location}</span>
                                </div>
                ...
                <div className="mb-2">
                    ...
                    {organizationsExperience.map((organization, index) => (
                        <div key={index}>
                            <div className="flex justify-between items-center mb-1">
                                <div style={{ lineHeight: `${editor.lineHeight}px` }}>
                                    <span className={`${editor.fontSize} font-semibold`}>{organization.name}</span>
                                    {' '}
                                    -
                                    <span className={`${editor.fontSize} font-semibold text-gray-500`}>{organization.location}</span>
                                </div>
                                <div className={`${editor.fontSize} text-right`} style={{ lineHeight: `${editor.lineHeight}px` }}>
